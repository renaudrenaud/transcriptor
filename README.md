...
- **Confidentialité totale** : l'audio ne quitte jamais la machine. Idéal pour les réunions sensibles.
...
- [Transcription](runbooks/transcription.md) — transcrire un fichier audio
